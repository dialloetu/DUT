...
monster.modules.actions = (function() {
    ...
    return {
        ...
        run: function() {
            if (awake && life > 1) {
                life--; // perte de 1 point de vie 
                monster.modules.app.log(name + " cour ");
                monster.modules.app.displayStatus(life, money, awake);
            }
        },
        fight: function() {
            if (awake && life > 3) {
                life -= 3; // perte de 3 points de vie
                monster.modules.app.log(name + " se bat ");
                monster.modules.app.displayStatus(life, money, awake);
            }
        },
        work: function() {
            if (awake && life > 1) {
                life -= 1;
                money += 2;
                monster.modules.app.log(name + " travail ");
                monster.modules.app.displayStatus(life, money, awake);
            }
        },
        eat: function() {
            if (awake && money > 3) {
                life += 2;
                money -= 3; // perte de 3 unités d'argent 
                monster.modules.app.log(name + " mange ");
                monster.modules.app.displayStatus(life, money, awake);
            }
        },
        ...
        sleep: function() {
            ...
            monster.modules.app.displayStatus(life, money, awake);
            setTimeout(function() {
                monster.modules.app.log(name + " se réveille ");
                life++;
                awake = true;
                monster.modules.app.displayStatus(life, money, awake);
            }, 10000);
